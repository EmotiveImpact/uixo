...
| ---------- | ------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------- |
| WEB        | Public Web / designers and developers                  | Curated websites, individual asset discovery, real previews, provenance, variants, useful filters, favourites, editorial collections and original acquisition routes | Established direction                                            | Partial and usable on preview; real component renders, save persistence and catalogue depth incomplete   |
| PRO        | Personal workspace / frequent builders                 | Mixed project boards, project requirements, comparisons, advanced discovery, compatibility guidance, export/acquisition and paid high-value assistance               | Proposed edition; personal saved projects are established scope  | Website lists and browser-local asset saves; no complete project workspace or paid entitlement           |
